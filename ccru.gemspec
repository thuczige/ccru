...
Gem::Specification.new do |spec|
  ...
  spec.summary = "RuboCop wrapper that lints only changed lines/files"
  spec.description = "Runs RuboCop on new files fully and on modified files only for changed lines based on git diff"
